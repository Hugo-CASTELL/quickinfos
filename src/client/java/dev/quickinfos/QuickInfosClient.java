...
public class QuickInfosClient implements ClientModInitializer {
	...
	private void onInitializeLoadStatic() {
		...
		for (Info info : new Info[] {new Coordinates(), new DeathCoordinates(), new TargetedBlock(), new TargetedBlockCoordinates(), new TargetedEntity(), new CurrentBiome(), new FacingDirection(), new FPS(), new Ping()}) {
			try {
