...
public class QuickInfoClient implements ClientModInitializer {
	...
	private void onInitializeRegisterEvents() {
		...
		HudLayerRegistrationCallback.EVENT.register(
				layeredDrawer -> layeredDrawer.attachLayerBefore(
						...
						Singleton.QUICKINFO_LAYER,
						QuickInfoClient::onCrosshairRender));
